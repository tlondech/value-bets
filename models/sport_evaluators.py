        ...
        for event in upcoming_events:
            ...
            if raw_signals:
                ...
                signals.append({
                    ...
                    "home_seed":       seeds.get(player1.lower()),
                    "away_seed":       seeds.get(player2.lower()),
                    "home_short_name": p1_label,
                    "away_short_name": p2_label,
                    "surface":        surface,
                    "stage":          stage,
        ...
        **_ignored,
        ...
        for event in upcoming_events:
            ...
            signals.append({
                ...
                "home_rest_days":  home_rest_days,
                "away_rest_days":  away_rest_days,
                "home_short_name": home_label,
                "away_short_name": away_label,
                "stage":           stage,
                "kickoff":        event["commence_time"].isoformat(),
                "sport":          "basketball",
                "bookmaker_link": event.get("bookmaker_link"),
